...
* GetPlaylistSongsActivity, AddSongToPlaylistActivity, UpdatePlaylistActivity, 
* GetPlaylistActivity, CreatePlaylistActivity

List the class(es) that `App.java` provides that **are** dependencies of other classes

* DynamoDBMapper, AlbumTrackDao, PlaylistDao

List the class(es) that `App.java` creates that have constructors we must annotate with `@Inject`

* AlbumTrackDao, PlaylistDao, GetPlaylistSongsActivity, AddSongToPlaylistActivity, UpdatePlaylistActivity,
* GetPlaylistActivity, CreatePlaylistActivity
